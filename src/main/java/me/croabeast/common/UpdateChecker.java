...
public final class UpdateChecker {
    ...
    public CompletableFuture<@NotNull UpdateResult> requestUpdateCheck() {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                String latest = versionScheme.apply(pluginVersion, current);
     ...
     */
    @FunctionalInterface
    public interface VersionScheme extends BinaryOperator<String> {
         ...
         */
        @Nullable
        String apply(@NotNull String first, @NotNull String second);
    }
