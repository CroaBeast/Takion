 ...
 * of panes and items in a paginated layout. It implements {@link UnaryBuilder} to allow chainable
...
public abstract class GuiBuilder<G extends Gui, B extends GuiBuilder<G, B>> implements UnaryBuilder<G, B> {
