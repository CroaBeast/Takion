package me.croabeast.lib.gui;

import com.github.stefvanschie.inventoryframework.pane.Pane;
import lombok.AccessLevel;
import lombok.Getter;
import lombok.RequiredArgsConstructor;
import me.croabeast.lib.builder.UnaryBuilder;
 ...
 * allowing the registration of click actions and other pane-specific configurations. It implements the {@link UnaryBuilder}
...
@Getter
public abstract class PaneBuilder<P extends Pane, B extends PaneBuilder<P, B>> implements UnaryBuilder<P, B> {
